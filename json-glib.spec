...
Source0  : https://download.gnome.org/sources/json-glib/1.6/json-glib-1.6.2.tar.xz
...
%prep
%setup -q -n json-glib-1.6.2
cd %{_builddir}/json-glib-1.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612908097
...
cp %{_builddir}/json-glib-1.6.2/COPYING %{buildroot}/usr/share/package-licenses/json-glib/e60c2e780886f95df9c9ee36992b8edabec00bcc
...
/usr/lib64/libjson-glib-1.0.so.0.600.2
